const lang = {
  ...
  search: 'search',
  'Predictive Dashboard': 'Predictive Dashboard',
  'Real-time analytics engine providing data-driven insights with futuristic visualizations.': 'Real-time analytics engine providing data-driven insights with futuristic visualizations.',
  'Automated Invoicing': 'Automated Invoicing',
  'High-velocity invoice generation with multi-currency support and automated tax calculations.': 'High-velocity invoice generation with multi-currency support and automated tax calculations.',
  'Advanced CRM': 'Advanced CRM',
  'Integrated client relationship module with comprehensive history and status tracking.': 'Integrated client relationship module with comprehensive history and status tracking.',
  'Modular Architecture': 'Modular Architecture',
  'A plugin-ready framework that adapts to your business needs without bloat.': 'A plugin-ready framework that adapts to your business needs without bloat.',
  'Encrypted Financials': 'Encrypted Financials',
  'Industry-standard security protocols for all payment records and financial transactions.': 'Industry-standard security protocols for all payment records and financial transactions.',
  'Dynamic Theming': 'Dynamic Theming',
  'Midnight Glass UI engine optimized for high-contrast focus and aesthetic excellence.': 'Midnight Glass UI engine optimized for high-contrast focus and aesthetic excellence.',
};
