    ...
    const component = {
      ...
      date: {
        ...
        render: (_, record) => {
          ...
          return (
            <Tag variant="filled" color={field.color}>
              {date}
            </Tag>
          );
        },
      ...
      async: {
        ...
        render: (text, record) => {
          return (
            <Tag variant="filled" color={field.color || record[key]?.color || record.color}>
              {text}
            </Tag>
          );
        },
      ...
      stringWithColor: {
        ...
        render: (text, record) => {
          return (
            <Tag variant="filled" color={record.color || field.color}>
              {text}
            </Tag>
          );
        },
      ...
      selectWithFeedback: {
        ...
        render: (text, record) => {
          if (field.renderAsTag) {
            ...
            return (
              <Tag variant="filled" color={selectedOption?.color}>
      ...
      array: {
        ...
        render: (_, record) => {
          return record[key].map((x) => (
            <Tag variant="filled" key={`${uniqueId()}`} color={field.colors[x]}>
              {x}
            </Tag>
          ));
        },
      ...
      country: {
        ...
        render: (_, record) => {
          ...
          return (
            <Tag variant="filled" color={field.color || undefined}>
